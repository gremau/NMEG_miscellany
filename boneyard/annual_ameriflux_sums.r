# This file creates datasets from (old) NMEG Ameriflux files and calculates
# Annual sums of fluxes. Primarily it was used for comparing Reichstein and 
# Lasslop partitioning
#
