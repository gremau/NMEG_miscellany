...
setwd('~/current/NMEG_misc/compare_flux_partitioning/')

source('~/current/NMEG_misc/r_functions/printfigs.r')

proc_path <- '../processed_data/'
raw_reich_path <- '~/sftp/eddyflux/Ameriflux_files_GM/2007-2013_Reichstein'
raw_lass_path <- '~/sftp/eddyflux/Ameriflux_files_GM/2007-2013_Lasslop'
...
colnames(df_reich) = c('year', 'doy', 'doy_w','year_w',
                       'US-Vcp', 'US-Vcm', 'US-Wjs', 'US-Mpj', 'US-Mpg',
                       'US-Ses', 'US-Ses', 'US-Sen')
